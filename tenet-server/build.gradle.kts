...
val log4jPlugins = sourceSets.create("log4jPlugins").java{
...
dependencies {
    implementation(project(":tenet-api"))
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "Tenet",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Tenet",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "Teneted Team",
            "Brand-Id" to "teneted:tenet",
            "Brand-Name" to "Teneted",
