 ...
 * <pre>
 * {@code
 *  ResourceKey<Registry<String>> key = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath("modid", "custom_registry"));
...
public final class FabricRegistryBuilder<T, R extends WritableRegistry<T>> {
	 ...
	 * @return An instance of FabricRegistryBuilder
	 */
	public static <T> FabricRegistryBuilder<T, DefaultedMappedRegistry<T>> createDefaulted(ResourceKey<Registry<T>> key, ResourceLocation defaultId) {
	 ...
	 */
	@Deprecated
	public static <T> FabricRegistryBuilder<T, MappedRegistry<T>> create(Class<T> type, ResourceLocation registryId) {
	...
	public R buildAndRegister() {
		...
		BuiltInRegistries.getWRITABLE_REGISTRY().register((ResourceKey<WritableRegistry<?>>) key, registry, RegistrationInfo.BUILT_IN);
